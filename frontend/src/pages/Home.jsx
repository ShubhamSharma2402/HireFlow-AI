...
import { Upload, FileText, CheckCircle, ArrowRight, Brain, Target, MessageSquare, RefreshCw, Layers, History } from 'lucide-react';
...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // Create a guest userId from name or random
      const data = new FormData();
      data.append('userName', formData.name || 'Candidate');
      data.append('jobText', formData.jobDescription);
      data.append('resume', formData.resumeFile); // multer field name: 'resume'
      ...
      <section className="hero">
        ...
        <div className="container hero-container fade-in-up">
          ...
          <p className="hero-subtitle">
            Upload your resume and a job description. Our agentic AI will rewrite, format, and optimize your application specifically for the role, beating ATS systems and impressing recruiters.
          </p>
              ...
              <div className="form-group">
                ...
                <div className="file-drop-area">
                  ...
                  <input 
                    ...
                    required
                  />
                  {formData.resumeFile && <p className="file-name text-green">{formData.resumeFile.name}</p>}
                </div>
              </div>
